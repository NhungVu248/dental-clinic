...
export default function DashboardPage() {
  ...
  const stats = [
    { label: 'Tổng tài khoản',         value: String(statsData?.totalUsers ?? '—'), desc: roleDesc || '—',       icon: Users,       color: '#3b82f6', bg: '#eff6ff' },
    { label: 'Dịch vụ đang hoạt động', value: '—', desc: 'Chưa có dữ liệu',                                      icon: Stethoscope, color: '#22c55e', bg: '#f0fdf4' },
    { label: 'Bảng giá hiệu lực',      value: '—', desc: 'Chưa có dữ liệu',                                      icon: Tag,         color: '#f59e0b', bg: '#fffbeb' },
    { label: 'Nhật ký hôm nay',        value: String(statsData?.todayLogs ?? '—'), desc: 'Hoạt động trong ngày', icon: ScrollText,  color: '#a855f7', bg: '#faf5ff' },
  ]
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '12px', border: '1px solid #f1f5f9', padding: '20px' }}>
          ...
          <p style={{ fontSize: '13px', color: '#9ca3af' }}>Xem chi tiết tại mục Nhật ký hệ thống (UC07).</p>
        </div>
